            ...
            ">
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form method="POST">
                                ...
                                include 'controlador/registro_usuario.php'; #incluyo el controlador de registro de la tarea
                                ?>
                                <!-- 2 column grid layout with text inputs for the first and last names -->
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div data-mdb-input-init class="form-outline">
                                            <input type="text" id="form3Example1" class="form-control" name="nombres" />
                                ...
                                <button type="submit" class="btn btn-primary" name="btnregistrarusuario"
                                    value="ok">Registrarse</button>
                                <!-- Submit button -->
